...
testing=[X(401:500,:) ;X(901:1000,:); X(1401:1500,:);X(1901:2000,:);X(4001:2500,:);X(2901:3000,:);X(3401:3500,:);X(3901:4000,:);X(4401:4500,:);X(4901:5000,:)];
...
Eout=[];
 ...
 for i=1:10
    ...
    [w] = stochastic_gradient_descent(training', lr);
%     Ein=[Ein in];
%     Eout=[Eout out];
 end
...
fprintf('Classification In error: %d \n',E1);
fprintf('classification Out error: %d \n',E2);
